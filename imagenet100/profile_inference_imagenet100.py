...
# -------------------------
@torch.no_grad()
def measure_inference(model, device, batch_size, iters=100, warmup=30):
...
def main():
    ...
    baseline_ckpt = "baseline_results_imagenet100.pth"
    svda_ckpt = "svda_results_imagenet100.pth"
    ...
    # Inference profiling (report both batch=1 and batch=32 like common practice)
    batches = [1, 32]
    results = {
        "env": {
    ...
    print("\n=== ImageNet-100 Inference Profiling ===")
    ...
    with open("imagenet100_inference_profile.json", "w") as f:
        json.dump(results, f, indent=2)
    print("\nSaved: imagenet100_inference_profile.json")
