...
def main():
    ...
    baseline_ckpt = "baseline_results_cifar100.pth"
    svda_ckpt = "svda_results_cifar100.pth"
    ...
    with open("cifar100_inference_profile.json", "w") as f:
        json.dump(results, f, indent=2)
    print("\nSaved: cifar100_inference_profile.json")
