...
class TransformerClassifier(nn.Module):
    def __init__(self, params):
        super().__init__()
        self.embed = PatchEmbedding(1, params["patch_size"], params["embed_dim"], params["image_size"])
...
def main():
    ...
    baseline_ckpt = "baseline_results_fashionMNIST.pth"
    svda_ckpt = "svda_results_fashionMNIST.pth"
    ...
    print("\n=== FashionMNIST Inference Profiling ===")
    ...
    with open("fashionmnist_inference_profile.json", "w") as f:
        json.dump(results, f, indent=2)
    print("\nSaved: fashionmnist_inference_profile.json")
